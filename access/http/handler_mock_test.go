...
// getTransactionsByBlockID provides a mock function with given fields: ctx, blockID, opts
func (_m *mockHandler) getTransactionsByBlockID(ctx context.Context, blockID string, opts ...queryOpts) ([]models.Transaction, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 []models.Transaction
	if rf, ok := ret.Get(0).(func(context.Context, string, ...queryOpts) []models.Transaction); ok {
		r0 = rf(ctx, blockID, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.Transaction)
		}
